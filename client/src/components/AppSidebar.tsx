...
import { useSidebar, Sidebar, SidebarHeader, SidebarMenu, SidebarMenuItem, SidebarContent, SidebarMenuButton } from './ui/sidebar';
    ...
    const navLinks =
        userType === "manager"
            ? [
                ...
                {
                    icon: Settings, label: "Configuraciones", href: "/managers/settings"
                },
            ] : [{
            ...
            },
            {
                ...
                icon: Settings, label: "Configuraciones", href: "/tenants/settings"
            }]
    return (
        ...
        >
            <SidebarHeader>
                <SidebarMenu>
                    <SidebarMenuItem>
                        <div className={cn("flex min-h-[56px] w-full items-center pt-3 mt-3", open ? "justify-between px-6" : "justify-center")}>
                            {
                                open ? (
                                    <>
