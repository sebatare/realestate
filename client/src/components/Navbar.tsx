                        ...
                        <Button
                            ...
                            {authUser.userRole?.toLowerCase() === 'manager' ? (
                                <>
                                    ...
                                    <span className='hidden md:block ml-2'>Agregar nueva propiedad</span>
                                </>
                            ) : (
                                <>
                                    <Search className='h-4 w-4' />
                                    <span className='hidden md:block ml-2'>
                                        Buscar propiedades</span>
                                </>
                            )}
                        </Button>
                    )}
                </div>
                {!isDashboardPage && (<p className='text-primary-200 hidden md:block'>Descubre tu derpatamente perfecto con nuestro avanzado sistema de busqueda</p>)}
                    ...
                    {authUser ? (<>
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent className='bg-white text-primary-700'>
                                <DropdownMenuItem className='cursor-pointer hover:!bg-primary-700 hover:!text-primary-100 font-bold'
                                    onClick={() => {
                                        router.push(
                                            authUser.userRole?.toLowerCase() === "manager" ?
                                                "/managers/properties"
